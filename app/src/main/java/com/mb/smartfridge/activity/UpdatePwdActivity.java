...
public class UpdatePwdActivity extends BaseActivity implements View.OnClickListener{
    ...
    private void doGetPw() {
        ...
        ApiMethods.getInstance().getpw(new ProgressSubscriber(forgetPwdOnNext, UpdatePwdActivity.this), mobile, password, code);
    }
    ...
    public void getValidCode() {
        ApiMethods.getInstance().sendSms(new ProgressSubscriber(sendSmsOnNext, UpdatePwdActivity.this), etTel.getText().toString().trim(), "getpw");
    }
}
